...
if (Meteor.isClient) {
  ...
  investedSubscription = Meteor.subscribe('invested');
  investingSubscription = Meteor.subscribe('investing');
}
...
FeedController = RouteController.extend({
  onBeforeAction: function() {
    this.feedSubscription = investedSubscription; //feedSubscription;
  }
});

Feed2Controller = RouteController.extend({
  onBeforeAction: function() {
    this.feedSubscription = investingSubscription; //feedSubscription;
  }
});
