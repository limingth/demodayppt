...
Template.recipe.helpers({
  ...
  slides: function() {
    //return Activities.find({recipeName: this.name}, {sort: {date: 1}});
    var first = Activities.find({recipeName: this.name}).fetch();
    console.log(first[0].slides);
    console.log(first[0].image);
    var count = first[0].slides;
    ...
    {
      var img = first[0].image;
      img += "image-" + zeroFill(i, 3) + ".jpg";
      console.log (img);
