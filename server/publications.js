...
Meteor.publish('invested', function() {
  //return Activities.find({}, {sort: {date: -1}, limit: 10});
  return Activities.find({type: "invested"}, {sort: {date: -1}, limit: 10});
});

Meteor.publish('investing', function() {
  return Activities.find({type: "investing"}, {sort: {date: -1}, limit: 10});
});
